...
public class MainActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private ImageView wificonfigbutton;
    private ImageView bluetoothconfigbutton;
    private ImageView usbconfigbutton;

    private ImageView infomationbutton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSwipeTorefreshContainer = (LinearLayout) findViewById(R.id.swipe_to_refresh_container);

        configbutton = (ImageView) findViewById(R.id.config_image_button);

        wificonfigbutton = (ImageView) findViewById(R.id.wificonfig_image_button);

        bluetoothconfigbutton = (ImageView) findViewById(R.id.bluetoothconfig_image_button);

        usbconfigbutton = (ImageView) findViewById(R.id.usbconfig_image_button);

        infomationbutton = (ImageView) findViewById(R.id.information_image_button);

        // Listen to the SwipeTorefresh events
        mDevicesSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.devices_swipe_to_refresh);
        mDevicesSwipeRefreshLayout.setOnRefreshListener(MainActivity.this);
        ...
        wificonfigbutton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent config = new Intent(MainActivity.this, WiFiConfigActivity.class);
                startActivity(config);
            }
        }

        );
        bluetoothconfigbutton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent config = new Intent(MainActivity.this, BluetoothConfigActivity.class);
                startActivity(config);
            }
        });

        usbconfigbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int numDevices = enumerateDevices();
                listDevices();
                if(numDevices == 0)
                    Toast.makeText(MainActivity.this, getString(R.string.lbl_no_device_found), Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(MainActivity.this, Integer.toString(numDevices) + " " + getString(R.string.lbl_device_found), Toast.LENGTH_SHORT).show();
            }
        });

        infomationbutton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {

...
public class WiFiConfigActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deviceName = (Spinner) findViewById(R.id.WiFiProducts);
        ...
        int permissionCheck = ContextCompat.checkSelfPermission(WiFiConfigActivity.this, Manifest.permission.INTERNET);
        if(permissionCheck!= PackageManager.PERMISSION_GRANTED){
            if(ActivityCompat.shouldShowRequestPermissionRationale(WiFiConfigActivity.this, Manifest.permission.INTERNET)){
            }else{
                ActivityCompat.requestPermissions(WiFiConfigActivity.this, new String[]{
        ...
        connect.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                try {
                    ...
                    {
                        Toast.makeText(WiFiConfigActivity.this, getString(R.string.ethernet_wifi_devices_usename_password), Toast.LENGTH_SHORT).show();
                        return;
                    }
                    else
                    {
                    ...
                    Toast.makeText(WiFiConfigActivity.this, getString(R.string.wifi_devices_not_found), Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                    return;
                }

                System.out.println(tc.isConnected());
            ...
            Intent config = new Intent(WiFiConfigActivity.this, DeviceViewActivity.class);

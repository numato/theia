...
package com.numato.theia.ui.adapters;
...
import com.numato.theia.model.devices.Analog;
...
public class AnalogArrayAdapter extends ArrayAdapter<Analog> {
    ...
    public class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            rowImage = (ImageView) view.findViewById(R.id.analogRowImage);
            rowText = (TextView) view.findViewById(R.id.analogRowText);
            analogrowResultText = (TextView) view.findViewById(R.id.analogrowResultText);
            analogrowResultPercentage = (TextView) view.findViewById(R.id.analogrowResultPercentage);
            rowProgressBar = (ProgressBar) view.findViewById(R.id.analogRowProgressBar);
        }
    }

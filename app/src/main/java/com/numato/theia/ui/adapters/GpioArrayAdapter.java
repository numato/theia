...
import com.numato.theia.model.devices.Gpio;
...
public class GpioArrayAdapter extends ArrayAdapter<Gpio> {
    ...
    public class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            rowImage = (ImageView) view.findViewById(R.id.gpioRowImage);
            rowText = (TextView) view.findViewById(R.id.gpioRowText);
            rowSwitch = (Switch) view.findViewById(R.id.gpioRowSwitch);
            rowCheckBox = (CheckBox) view.findViewById(R.id.gpioRowCheckBox);
        }
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        rowCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                final int currentPosition = (listView != null ? listView.getPositionForView(currentRow) : 0);
